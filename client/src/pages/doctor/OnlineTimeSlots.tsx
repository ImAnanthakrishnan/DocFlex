...
const OnlineTimeSlots = () => {
  ...
  const validateForm = () => {
    ...
    if (formData?.onlineTimeSlots) {
      newErrors.onlineTimeSlots = formData.timeSlots.map((slot) => {
        const error: any = {};
        if (!slot.day) {
  ...
  const addOnlineTimeSlots = (e: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    e.preventDefault();

    addItem("onlineTimeSlots", {
      day: "",
      startingTime: "",
      endingTime: "",
      patientPerDay:""
  ...
  const handleOnlineTimeSlotsChange = (
    event: React.ChangeEvent<HTMLInputElement | HTMLSelectElement>,
    index: number
  ) => {
    handleReusableInputChangeFnc("onlineTimeSlots", index, event);
  };

  const deleteOnlineTimeSlots = (
    e: React.MouseEvent<HTMLButtonElement>,
    index: number
  ) => {
    e.preventDefault();
    deleteItem("onlineTimeSlots", index);
  };
  ...
  return (
    ...
    <div className="mb-5">
          <p className="form__label">Online Time Slots</p>
          {formData.onlineTimeSlots?.map((item, index) => (
            <div key={index}>
              <div>
                <div className="grid grid-cols-2 md:grid-cols-4 mb-[30px] gap-5">
                  <div>
                    ...
                    <select
                     name="day"
                      ...
                      onChange={(e) => handleOnlineTimeSlotsChange(e, index)}
                    >
                    ...
                    {errors?.onlineTimeSlots?.[index]?.day && (
                  ...
                  <div>
                    ...
                    <input
                     ...
                     // {...register(`timeSlots.${index}.startingTime`)}
                      ...
                      onChange={(e) => handleOnlineTimeSlotsChange(e, index)}
                    />
                    {errors?.onlineTimeSlots?.[index]?.startingTime && (
                      <p className="text-red-300">
                        {errors?.onlineTimeSlots?.[index]?.startingTime}
                      </p>
                    )}
                  ...
                  <div>
                    ...
                    <input
                     ...
                     // {...register(`timeSlots.${index}.endingTime`)}
                      ...
                      onChange={(e) => handleOnlineTimeSlotsChange(e, index)}
                    />
                    {errors?.onlineTimeSlots?.[index]?.endingTime && (
                      <p className="text-red-300">
                        {errors?.onlineTimeSlots?.[index]?.endingTime}
                      </p>
                    )}
                  ...
                  <div>
                    ...
                    <input
                     ...
                     // {...register(`timeSlots.${index}.endingTime`)}
                      ...
                      onChange={(e) => handleOnlineTimeSlotsChange(e, index)}
                    />
                    {errors?.onlineTimeSlots?.[index]?.patientPerDay && (
                      <p className="text-red-300">
                        {errors?.onlineTimeSlots?.[index]?.patientPerDay}
                      </p>
                    )}
                  ...
                  <div className="flex items-center">
                    <button
                      onClick={(e) => deleteOnlineTimeSlots(e, index)}
...
export default OnlineTimeSlots
